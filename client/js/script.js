...
function getData(){
	...
	for (var i = 0; i < astrsigns.length; i++){
		if(userSearch === astrsigns[i].name.toLowerCase()){
			document.getElementById('name').innerHTML = astrsigns[i].name;
			document.getElementById('date').innerHTML = astrsigns[i].month;
			document.getElementById('img').src = astrsigns[i].image;
			document.getElementById('text-result').innerHTML = astrsigns[i].description;
		}
	}
}